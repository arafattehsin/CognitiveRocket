...
namespace TaskBot
{
    ...
    public class Startup
    {
        ...
        {
            services.AddGoogleBot<TaskBot>(options =>
            {
                options.GoogleOptions.ActionInvocationName = "Cognitive Bank";
                options.GoogleOptions.ShouldEndSessionByDefault = true;
            });
        ...
        ";
            ...
            services.AddBot<TaskBot>(options =>
           {
               options.CredentialProvider = new SimpleCredentialProvider(endpointService.AppId, endpointService.AppPassword);
                ...
                // configured ILogger.
                ILogger logger = _loggerFactory.CreateLogger<TaskBot>();
