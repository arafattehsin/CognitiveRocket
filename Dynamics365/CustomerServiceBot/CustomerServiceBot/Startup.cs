...
using Models;
using static CustomerServiceBot.BotServices;
...
namespace CustomerServiceBot
{
    ...
    public class Startup
    {
        ...
        ";
            ...
            services.AddBot<CustomerServiceBot>(options =>
           {
               options.CredentialProvider = new SimpleCredentialProvider(endpointService.AppId, endpointService.AppPassword);

                // Catches any errors that occur during a conversation turn and logs them to currently
                // configured ILogger.
                ILogger logger = _loggerFactory.CreateLogger<CustomerServiceBot>();
            ...
            services.AddSingleton<CustomerServiceBotAccessors>(sp =>
            {
                // Create the custom state accessor.
                // State accessors enable other components to read and write individual properties of state.
                var accessors = new CustomerServiceBotAccessors(conversationState, userState)
                {
                    ProspectInfoAccessor = userState.CreateProperty<Prospect>(CustomerServiceBotAccessors.CustomerInfoAccessorName),
                    DialogStateAccessor = conversationState.CreateProperty<DialogState>(CustomerServiceBotAccessors.DialogStateAccessorName),
                };
