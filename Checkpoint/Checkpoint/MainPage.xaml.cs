...
namespace Checkpoint
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            //OpenALPRLibrary.NumberPlate plate = new OpenALPRLibrary.NumberPlate();
        ...
        {
            await TakePhotoAndGetNumberAsync();
        }
        ...
        #region Changed by Arafat
        private async Task<string> TakePhotoAndGetNumberAsync()
        {
            ...
            try
            {
                var bytes = await ConvertToBytes(stream);
                ...
                using (var client = new HttpClient())
                {
                    ...
                    //api endpoint
                    var apiUri = new Uri("https://api.openalpr.com/v2/recognize?secret_key=[yourkey]&recognize_vehicle=0&country=sa&return_image=0&topn=10");
                    ...
                    var jsonResult = JsonConvert.DeserializeObject<Rootobject>(responseString);
        ...
        public async Task<byte[]> ConvertToBytes(IRandomAccessStream stream)
        {
